...
使用者tips:
退出venv虚拟环境 deactivate
首次cmake cmake -G "MinGW Makefiles" ..
词法分析测试语句 compiler "E:/C++Projects/Compiler/a.txt" -s0 -o "E:/C++Projects/Compiler/b.txt"
make指令 mingw32-make
比较两个文件 diff "E:/C++Projects/Compiler/a.txt" "E:/C++Projects/Compiler/b.txt" -w
错误之处使用 assert(0)
bison分析指令 bison --yacc -dv test.y